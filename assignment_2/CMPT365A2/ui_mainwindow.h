...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy1.setHeightForWidth(displayTabs->sizePolicy().hasHeightForWidth());
        displayTabs->setSizePolicy(sizePolicy1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 554, 474));
        ...
        sizePolicy2.setHeightForWidth(qualityDisplay->sizePolicy().hasHeightForWidth());
        qualityDisplay->setSizePolicy(sizePolicy2);
        qualityDisplay->setReadOnly(true);

        gridLayout->addWidget(qualityDisplay, 8, 5, 1, 1);
        ...
        gridLayout->addWidget(comboBox_2, 7, 5, 1, 1);
        ...
        sizePolicy2.setHeightForWidth(qualitySlider->sizePolicy().hasHeightForWidth());
        qualitySlider->setSizePolicy(sizePolicy2);
        ...
        sizePolicy4.setHeightForWidth(quantDisplay_lum->sizePolicy().hasHeightForWidth());
        quantDisplay_lum->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(quantDisplay_chr->sizePolicy().hasHeightForWidth());
        quantDisplay_chr->setSizePolicy(sizePolicy4);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        comboBox_2->setItemText(0, QApplication::translate("MainWindow", "Prefered Quantization", nullptr));
        comboBox_2->setItemText(1, QApplication::translate("MainWindow", "Uniform Quantization", nullptr));
        comboBox_2->setItemText(2, QApplication::translate("MainWindow", "Linear Quantization", nullptr));
        comboBox_2->setItemText(3, QApplication::translate("MainWindow", "Exponental Quantization", nullptr));
